          ...
          <div className="activity-section">
            <div className="section-container">
              ...
              <div className="activity-list">
                ...
                {/* Show recent ticket if available */}
                {tickets.length > 0 && (
                  <div className="activity-item">
                    <div className="activity-icon" style={{ color: '#e63946',
                      boxShadow: '0 3px 8px rgba(230,57,70,.1)' }}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                          viewBox="0 0 24 24" fill="none" stroke="currentColor"
                          strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M2 9a3 3 0 1 0 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 1 0 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v2z" />
                    ...
                    <div className="activity-details">
                      <div className="activity-title">Parking Ticket {tickets[0].status === 'paid' ? '(Paid)' : '(Pending)'}</div>
                      <div className="activity-meta">
                        <div><span className="meta-icon">📝</span> {tickets[0].reason}</div>
                        <div><span className="meta-icon">🕒</span> {formatDate(tickets[0].issueDate)}</div>
                      </div>
                    </div>
                    <div className="activity-amount">{formatCurrency(tickets[0].amount)}</div>
                  </div>
                )}
                ...
                {pendingTickets > 0 && (
                  <div className="notification-item urgent">
                    <div className="notification-header">
                      <div className="notification-type">Ticket Due</div>
                      <div className="notification-time">1 day ago</div>
                    </div>
                    <div className="notification-message">
                      You have {pendingTickets} pending parking {pendingTickets === 1 ? 'ticket' : 'tickets'} that requires payment. Please review and pay to avoid additional fees.
                    </div>
