                        ...
                        <div className="reservation-detail">
                          ...
                          <span className="reservation-detail-value">
                            {reservation.spot?.spotId ||
                              (typeof reservation.spot === "string"
                                ? reservation.spot.substring(0, 8)
                                : "N/A")}
                          </span>
                        </div>
                        ...
                        <div className="reservation-detail">
                          ...
                          <span className="reservation-detail-value">
                            {reservation.lot?.officialLotName ||
                              (typeof reservation.lot === "string"
                                ? "Lot " + reservation.lot.substring(0, 6)
                                : "N/A")}
                          </span>
                        </div>
                      ...
                      {status === "pending" && (
                        <>
                          <button
                            ...
                            onClick={() =>
                              navigate(`/modify-reservation/${reservation._id}`)
                            }
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
